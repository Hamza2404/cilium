...
// UUID. An object is buildabe if it implements GetUUID(). An object can build
// itself if it implements a Build() method.
//
...
// the build request will deferred. It wil be scheduled into the build queue
